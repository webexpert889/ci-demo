...
<section class="content m-t-54">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="h-left clearfix">
                    <h2 style="text-transform:uppercase;"><?php echo $this->lang->line('user_create_title'); ?></h2>
                    <small><?php echo $this->lang->line('welcome_title_admin_customer_create_page'); ?></small>
                    <ol class="breadcrumb breadcrumb-col-pink p-l-0">
                        ...
                        <li class="active"><?php echo $this->lang->line('user_create_title'); ?></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <form action="<?php echo base_url('users/create'); ?>" method="POST" autocomplete="off" id="form_validation" >
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="FirstName" id="FirstName" class="form-control" placeholder="<?php echo $this->lang->line('first_name_placeholder'); ?>" value="<?php echo set_value('FirstName'); ?>" required>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="LastName" id="LastName" class="form-control" placeholder="<?php echo $this->lang->line('last_name_placeholder'); ?>" value="<?php echo set_value('LastName'); ?>" required>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="email" name="Email" id="Email" class="form-control" placeholder="<?php echo $this->lang->line('email_placeholder'); ?>" value="<?php echo set_value('Email'); ?>" required >
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input minlength="10" min="1" type="number" name="Phone" id="Phone" class="form-control" placeholder="<?php echo $this->lang->line('phone_placeholder'); ?>" value="<?php echo set_value('Phone'); ?>">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="CompanyName" id="CompanyName" class="form-control" placeholder="<?php echo $this->lang->line('company_name_placeholder'); ?>" value="<?php echo set_value('CompanyName'); ?>" required >
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="CompanyAddress" id="CompanyAddress" class="form-control" placeholder="<?php echo $this->lang->line('company_address_placeholder'); ?>" value="<?php echo set_value('CompanyAddress'); ?>" required >
                                </div>
                                ...
                                <div class="form-line">
                                    <select data-live-search="true" data-size="10" name="Country_Id" class="form-control show-tick" required >
                                        ...
                                        <?php foreach ($CountryInfo as $Country) { ?>
                                            <option value="<?php echo $Country['Country_Id']; ?>" <?php echo (set_value('Country_Id') == $Country['Country_Id'] ? 'selected' : ''); ?> ><?php echo $Country['CountryName']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-line">
                                    <select name="AccountType" class="form-control show-tick" required >
                                        <option value=""><?php echo $this->lang->line('select_account_type_title'); ?></option>
                                       	<option value="1" <?php echo (set_value('AccountType') == '1' ? 'selected' : ''); ?> >abc Export</option>
                                        <option value="2" <?php echo (set_value('AccountType') == '2' ? 'selected' : ''); ?> >abc France</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-line">
                                    <select name="Currency_Id" class="form-control show-tick" required >
                                        ...
                                        <?php foreach ($CurrencyInfo as $Currency) { ?>
                                            <option value="<?php echo $Currency['Currency_Id']; ?>" <?php echo (set_value('Currency_Id') == $Currency['Currency_Id'] ? 'selected' : ''); ?> ><?php echo $Currency['Name']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-line">
                                    <select name="Language" class="form-control show-tick" required >
                                        ...
                                        <?php foreach ($LanguageInfo as $Language) { ?>
                                            <option value="<?php echo $Language['Value']; ?>" <?php echo (set_value('Language') == $Language['Value'] ? 'selected' : ''); ?> ><?php echo $Language['Name']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <label for="User_comment">
                                <?php echo $this->lang->line('comment_label'); ?>
                                <span style="color:red">*</span>
                            </label>
                             <div class="form-group">
                                <div class="form-line">
                                <textarea  class="form-control" rows="4" cols="50" name="User_comment" class="form-control show-tick" value="<?php echo set_value('User_comment'); ?>" required>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                    ...
                                    if (isset($BrandInfo) && !empty($BrandInfo)) {
                                        ...
                                        foreach ($BrandInfo as $Brand) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
												<?php 
												if($Brand['PriceType']==='Buying') {
													echo $this->lang->line('pricetype_1');
												}
												else if($Brand['PriceType']==='Public') {
													echo $this->lang->line('pricetype_2');
												} 
												?>
												</td>
                                                <td>
                                                    <input type="number" name="Value_<?php echo $i; ?>" style="text-align:right;font-size:14px;font-family: &quot;Work Sans&quot;,Arial,Tahoma,sans-serif; font-weight:400;" min="0" value="<?php echo (set_value('Value_' . $i)) ? set_value('Value_' . $i) : $Brand['DefaultCoefficient']; ?>" required>
                                                </td>
                                                <td>
                                                    <div class="switch">
                                                        <label>
                                                            <input class="value_checkbox" rel="<?php echo $i; ?>" name="Status_<?php echo $i; ?>" type="checkbox" checked >
                            ...
                            <button type="submit" class="btn btn-raised btn-primary m-t-15 waves-effect">
                                <?php echo $this->lang->line('create_button'); ?>
                            </button>
                        </div>
                    </div>
                </div>
